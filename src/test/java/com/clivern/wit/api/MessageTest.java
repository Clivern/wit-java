...
public class MessageTest extends TestCase {
    ...
    public void testGet01() throws DataNotValid, DataNotFound, UnsupportedEncodingException {
        ...
        assertEquals(
                message.debug(),
                "> curl -XGET 'https://api.wit.ai/message?v=20180225&q=Good Morning&msg_id=789&thread_id=fb_th&n=6&verbose=true' -H \"Authorization: Bearer access__token\" -H \"Content-Type: application/json\"");
    }
    ...
    public void testGet02() throws DataNotValid, DataNotFound, UnsupportedEncodingException {
        ...
        assertEquals(
                message.debug(),
                "> curl -XGET 'https://api.wit.ai/message?v=20180225&q=Good Morning' -H \"Authorization: Bearer access__token\" -H \"Content-Type: application/json\"");
    }
    ...
    public void testGet03() throws DataNotValid, DataNotFound, UnsupportedEncodingException {
        ...
        assertEquals(
                message.debug(),
                "> curl -XGET 'https://api.wit.ai/message?v=20180225&q=Good Morning&thread_id=fb_th&verbose=false' -H \"Authorization: Bearer access__token\" -H \"Content-Type: application/json\"");
    }
}
